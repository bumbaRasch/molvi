...
pub fn build(app: &AppHandle) -> tauri::Result<tauri::tray::TrayIcon> {
    ...
    TrayIconBuilder::with_id("main")
        ...
        .menu(&menu)
        // Single left-click opens the native menu (Windows default) — leave
        // show_menu_on_left_click at its default (true). Double-click opens
        // settings (Ruling 3: close the Phase-1 click-on-all-variants deferral).
